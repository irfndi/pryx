...
use pryx::message::{ContentBlock, Role};
use pryx::process_memory;
...
fn main() -> anyhow::Result<()> {
    ...
    let display_messages = pryx::tui::display_messages_from_session(&session);
    ...
    let client_memory = pryx::tui::transcript_memory_profile(
        &session,
