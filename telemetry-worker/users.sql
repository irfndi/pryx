-- Canonical "total users" definitions for pryx telemetry.
-- Usage:
...
-- ever either installed pryx or did meaningful work in it. We exclude CI traffic
...
SELECT
    -- HEADLINE: real people who installed or meaningfully used pryx.
    (SELECT COUNT(*) FROM (
    ...
    -- Reach: every distinct non-CI id that ever launched pryx (incl. empty
