...
Pryx to browse the expected sponsored-discovery category and receive a specific
...
The default uses Pryx's normal toolset so Discovery competes with built-in
...
The runner uses a dedicated Pryx server with:
