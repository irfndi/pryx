...
- [x] User control CLI (`pryx memory` commands)
...
Similar to how humans consolidate memories during sleep, pryx can run background consolidation to optimize the memory graph:
