#!/usr/bin/env python3
"""
Reproduce the "slash command menu flickers in a freshly spawned pryx" bug.
...
def main() -> int:
    ...
    root = Path(tempfile.mkdtemp(prefix="pryx-slash-flicker-"))
    ...
    env.setdefault("PRYX_PERF_TIER", "full")
    ...
    if not args.json:
        print("== pryx slash-menu flicker repro ==")
