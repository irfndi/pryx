#!/usr/bin/env python3
"""
Profile a live, freshly spawned pryx TUI while the decorative idle animation
...
def main() -> int:
    ...
    root = Path(os.environ.get("PRYX_SCRATCH_DIR") or tempfile.gettempdir())
    root = Path(tempfile.mkdtemp(prefix="pryx-profile-donut-", dir=str(root)))
