...
SOCKET_PATH = f"/run/user/{os.getuid()}/pryx-debug.sock"
MAIN_SOCKET_PATH = f"/run/user/{os.getuid()}/pryx.sock"
...
def main():
    ...
    if not os.path.exists(SOCKET_PATH):
        ...
        print("Make sure pryx server is running with debug control enabled.")
