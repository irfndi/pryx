#!/usr/bin/env python3
"""Aggregate a pryx Terminal-Bench Harbor job dir and compare against the
...
def main() -> int:
    ...
    print(f"{'task':38} {'base%':>7} {'pryx%':>7} {'pass':>6} {'flag'}")
    print("-" * 75)
    ...
    print("-" * 75)
    if pryx_trials:
        print(f"pryx micro-avg: {pryx_resolved}/{pryx_trials} = {100*pryx_resolved/pryx_trials:.1f}%")
