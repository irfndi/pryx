#!/bin/bash
# Screenshot Watcher - monitors for pryx screenshot signals
#
# This script watches the signal directory and captures screenshots
# when pryx signals that a specific UI state is ready.
#
# Usage: ./screenshot_watcher.sh [window_id]
#
# Start pryx with: /screenshot-mode on

set -e

SIGNAL_DIR="${XDG_RUNTIME_DIR:-/tmp}/pryx-screenshots"
...
echo "Enable in pryx with: /screenshot-mode on"
echo ""
