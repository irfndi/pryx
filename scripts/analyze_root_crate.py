#!/usr/bin/env python3
"""Analyze the monolithic root `pryx` crate to plan a bottom-up split.
...
computes:
  ...
  - facade: whether it is already just `pub use pryx_*::*;`
...
FACADE_RE = re.compile(r"pub use pryx_[a-z0-9_]+::")
