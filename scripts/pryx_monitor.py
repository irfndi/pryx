#!/usr/bin/env python3
"""
pryx Live Monitor - Real-time activity dashboard

Connects to pryx's debug socket and displays live streaming events.
Run pryx serve in one terminal, then this monitor in another.

Usage: ./pryx_monitor.py [--socket PATH]
"""
...
def get_socket_path() -> str:
    """Get the pryx debug socket path"""
