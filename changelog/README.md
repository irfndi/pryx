...
User-facing changelog entries for pryx releases. One JSON file per release,
written by the agent during `/cut-release`, reviewed in the release diff, and
consumed by pryx.sh and the GitHub release body.
...
- Write for users of pryx, not contributors. Describe the effect, not the
