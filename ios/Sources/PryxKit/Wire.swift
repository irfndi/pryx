...
/// Client request to a pryx server.
///
/// Wire format mirrors `crates/pryx-protocol/src/wire.rs` (`#[serde(tag = "type")]`,
...
/// Server event from a pryx server. Unknown event types decode as `.unknown`
