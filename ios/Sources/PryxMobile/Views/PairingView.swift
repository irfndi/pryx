        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Button {
                    ...
                    Label("Scan QR from `pryx pair`", systemImage: "qrcode.viewfinder")
                        .font(.subheadline)
                        .frame(maxWidth: .infinity)
                        .padding(.vertical, 14)
                ...
                Text("Run `pryx pair` on your machine, then scan the QR code or enter the code manually. Traffic stays on your tailnet.")
                    .font(.footnote)
        ...
        .sheet(isPresented: $showScanner) {
            QRScannerView { scanned in
                ...
                if let payload = PairURI.parse(scanned) {
                    ...
                    errorMessage = "Not a pryx pairing QR code"
                }
            }
        }
    }
