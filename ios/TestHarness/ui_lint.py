#!/usr/bin/env python3
"""Design-system discipline linter for the pryx iOS SwiftUI sources.
...
Usage:
  python3 ui_lint.py [--root Sources/PryxMobile] [--json] [--max-issues N]
...
def main():
    ...
    default_root = Path(__file__).resolve().parent.parent / "Sources" / "PryxMobile"
