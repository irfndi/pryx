#!/usr/bin/env python3
"""Deterministic mock pryx gateway for end-to-end iOS app testing.

Speaks the exact wire protocol from `crates/pryx-base/src/gateway.rs` on a
