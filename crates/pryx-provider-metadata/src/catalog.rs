...
pub const OPENCODE_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    ...
    setup_url: "https://github.com/pryx-co/pryx#openai-compatible-providers",
...
pub const PRYX_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "pryx",
    display_name: "Pryx Subscription",
    auth_kind: LoginProviderAuthKind::ApiKey,
    auth_state_key: LoginProviderAuthStateKey::Pryx,
    auth_status_method: "API key",
    aliases: &["subscription", "pryx-subscription"],
    menu_detail: "curated pryx subscription models",
    recommended: false,
    target: LoginProviderTarget::Pryx,
