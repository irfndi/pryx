...
//!
//! Usage:
//!   cargo run -p pryx-harness-api --example harness_repl -- \
//!     [socket_path] [message]
//!
...
//!   cargo run -p pryx-harness-api --example harness_repl -- --demo
...
fn default_socket_path() -> String {
    ...
    format!("{home}/.pryx/pryx-api.sock")
}
        ...
        while {
            ...
            match req["req"].as_str().unwrap_or("") {
                ...
                "create_session" => reply(&ServerFrame::reply(
                    id,
                    ApiEvent::Attached {
                        session: pryx_harness_api::SessionInfo {
