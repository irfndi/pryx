...
use crate::{ApiEvent, Error, PryxClient, RunOptions, ToolCall, TurnResult, Usage};
...
/// JSON Schema accepted by [`PryxClient::run_structured`].
...
/// One model attempt made by [`PryxClient::run_structured`].
#[derive(Debug, Clone, PartialEq, Eq)]
...
/// An invalid JSON Schema supplied to [`PryxClient::run_structured`].
#[derive(Debug, Clone, PartialEq, Eq)]
