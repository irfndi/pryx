//! Rust SDK for the pryx harness.
//!
//! The API crate (`pryx-harness-api`) defines the wire protocol. This crate
...
//!
//! ```no_run
//! use pryx_sdk::{ConnectOptions, PryxClient, RunOptions};
//!
//! let client = PryxClient::connect(ConnectOptions::default())?;
...
pub use client::{
    ...
    PryxClient, RunOptions, RuntimeInfo, SearchTextOptions, ToolCall, Transport, TurnResult,
    UnixTransport, Usage,
};
...
pub use launch::{
    ...
    socket_accepts, user_app_config_dir, user_pryx_home, wait_for_socket,
};
pub use structured::{
...
pub use pryx_harness_api as api;
pub use pryx_harness_api::{
