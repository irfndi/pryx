...
use crate::storage;
use pryx_gateway_types::{PairedDevice, PairingCode};

// ---------------------------------------------------------------------------
// Device registry (persisted to ~/.pryx/devices.json)
// ---------------------------------------------------------------------------
...
impl DeviceRegistry {
    /// Load from ~/.pryx/devices.json
    pub fn load() -> Self {
        let path = match storage::pryx_dir() {
    ...
    /// Save to ~/.pryx/devices.json
    pub fn save(&self) -> Result<()> {
        let path = storage::pryx_dir()?.join("devices.json");
