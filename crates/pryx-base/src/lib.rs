//! `pryx-base`: foundational layer of the pryx application core.
//!
//! This crate holds the downward-closed set of modules that the upper
//! server/tool/agent layer (`pryx-app-core`) depends on: provider, auth,
...
//!
//! `pryx-app-core` re-exports this crate via `pub use pryx_base::*`, so every
...
pub use pryx_core::{terminal_eprint, terminal_eprintln, terminal_print, terminal_println};
