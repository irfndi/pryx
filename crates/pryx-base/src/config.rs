//! Configuration file support for pryx
//!
//! Config is loaded from `~/.pryx/config.toml` (or `$PRYX_HOME/config.toml`)
//! Environment variables override config file settings.

pub use pryx_config_types::{
...
const CONFIG_ENV_KEYS: &[&str] = &[
    "HOME",
    "PRYX_ACP_PROFILE",
    "PRYX_ACP_TOOL_PROFILE",
    "PRYX_ACTIVE_SESSIONS_MANAGER",
    "PRYX_EXTERNAL_SESSIONS",
    "PRYX_AMBIENT_ENABLED",
    "PRYX_AMBIENT_MAX_INTERVAL",
    "PRYX_AMBIENT_MIN_INTERVAL",
    "PRYX_AMBIENT_MODEL",
    "PRYX_AMBIENT_PROACTIVE",
    "PRYX_AMBIENT_PROVIDER",
    "PRYX_AMBIENT_VISIBLE",
    "PRYX_ANIMATION_FPS",
    "PRYX_AUTO_POKE",
    "PRYX_AUTOJUDGE_ENABLED",
    "PRYX_AUTOJUDGE_MODEL",
    "PRYX_AUTOREVIEW_ENABLED",
    "PRYX_AUTOREVIEW_MODEL",
    "PRYX_AUTO_POKE",
    "PRYX_AUTO_SERVER_RELOAD",
    "PRYX_BING_API_KEY",
    "PRYX_BING_API_KEY_ENV",
    "PRYX_BING_MARKET",
    "PRYX_CENTERED_TOGGLE_KEY",
    "PRYX_CHAT_NATIVE_SCROLLBAR",
    "PRYX_COMPACT_NOTIFICATIONS",
    "PRYX_COPY_BADGE_ALT_LABEL",
    "PRYX_COPY_SELECTION_TOGGLE_KEY",
    "PRYX_COPILOT_PREMIUM",
    "PRYX_CROSS_PROVIDER_FAILOVER",
    "PRYX_DEBUG_SOCKET",
    "PRYX_DEFAULT_REASONING_DISPLAY",
    "PRYX_DICTATION_COMMAND",
    "PRYX_DICTATION_KEY",
    "PRYX_DICTATION_MODE",
    "PRYX_DICTATION_TIMEOUT_SECS",
    "PRYX_DIFF_LINE_WRAP",
    "PRYX_DIFF_MODE",
    "PRYX_DIFF_MODE_CYCLE_KEY",
    "PRYX_DIAGRAM_PANE_TOGGLE_KEY",
    "PRYX_DISABLE_BASE_TOOLS",
    "PRYX_DISABLED_ANIMATIONS",
    "PRYX_DISABLED_TOOLS",
    "PRYX_DISCORD_BOT_TOKEN",
    "PRYX_DISCORD_BOT_USER_ID",
    "PRYX_DISCORD_CHANNEL_ID",
    "PRYX_DISCORD_REPLY_ENABLED",
    "PRYX_DISPLAY_CENTERED",
    "PRYX_EFFORT_DECREASE_KEY",
    "PRYX_EFFORT_INCREASE_KEY",
    "PRYX_EMAIL_REPLY_ENABLED",
    "PRYX_EMAIL_TO",
    "PRYX_FOCUS_HOOK",
    "PRYX_GATEWAY_BIND_ADDR",
    "PRYX_GATEWAY_ENABLED",
    "PRYX_GATEWAY_PORT",
    "PRYX_HOME",
    "PRYX_HOOK_PRE_TOOL",
    "PRYX_HOOK_PRE_TOOL_TIMEOUT_MS",
    "PRYX_HOOK_POST_TOOL",
    "PRYX_HOOK_SESSION_END",
    "PRYX_HOOK_SESSION_START",
    "PRYX_HOOK_TURN_END",
    "PRYX_HOOK_TURN_START",
    "PRYX_IDLE_ANIMATION",
    "PRYX_IMAP_HOST",
    "PRYX_INFO_WIDGET_TOGGLE_KEY",
    "PRYX_JADE_RELAY_API_BASE",
    "PRYX_JADE_RELAY_ENABLED",
    "PRYX_JADE_RELAY_LAUNCH_ENABLED",
    "PRYX_JADE_RELAY_LAUNCH_WORKING_DIR",
    "PRYX_JADE_RELAY_REPLY_ENABLED",
    "PRYX_JADE_RELAY_SESSION_ID",
    "PRYX_JADE_RELAY_TOKEN",
    "PRYX_JADE_RELAY_TOKEN_ID",
    "PRYX_JADE_RELAY_USER_ID",
    "PRYX_KV_CACHE_MISS_NOTICES",
    "PRYX_LATEX_RENDERING",
    "PRYX_MARKDOWN_SPACING",
    "PRYX_MEMORY_EMBEDDING_BACKEND",
    "PRYX_MEMORY_EMBEDDING_BASE_URL",
    "PRYX_MEMORY_EMBEDDING_DIM",
    "PRYX_MEMORY_EMBEDDING_MODEL",
    "PRYX_MEMORY_ENABLED",
    "PRYX_ENABLE_MERMAID",
    "PRYX_MEMORY_MODEL",
    "PRYX_MEMORY_SIDECAR_ENABLED",
    "PRYX_PERSIST_MEMORY_INJECTIONS",
    "PRYX_MESSAGE_TIMESTAMPS",
    "PRYX_MODEL",
    "PRYX_MODEL_SWITCH_KEY",
    "PRYX_MODEL_SWITCH_PREV_KEY",
    "PRYX_MOUSE_CAPTURE",
    "PRYX_NEW_TERMINAL_KEY",
    "PRYX_NO_EMOJI",
    "PRYX_NTFY_SERVER",
    "PRYX_NTFY_TOPIC",
    "PRYX_OPENAI_NATIVE_COMPACTION_MODE",
    "PRYX_OPENAI_NATIVE_COMPACTION_THRESHOLD_TOKENS",
    "PRYX_OPENAI_REASONING_EFFORT",
    "PRYX_OPENAI_SERVICE_TIER",
    "PRYX_OPENAI_TRANSPORT",
    "PRYX_ANTHROPIC_REASONING_EFFORT",
    "PRYX_PRESERVE_REASONING_CONTEXT",
    "PRYX_PERFORMANCE",
    "PRYX_PIN_IMAGES",
    "PRYX_PIN_TODOS",
    "PRYX_PREVENT_SLEEP_WHILE_STREAMING",
    "PRYX_PROVIDER",
    "PRYX_PROMPT_ENTRY_ANIMATION",
    "PRYX_QUEUE_MODE",
    "PRYX_REASONING_DISPLAY",
    "PRYX_REDRAW_FPS",
    "PRYX_SAME_PROVIDER_ACCOUNT_FAILOVER",
    "PRYX_SCROLL_BOOKMARK_KEY",
    "PRYX_SCROLL_DOWN_FALLBACK_KEY",
    "PRYX_SCROLL_DOWN_KEY",
    "PRYX_SCROLL_PAGE_DOWN_KEY",
    "PRYX_SCROLL_PAGE_UP_KEY",
    "PRYX_SCROLL_PROMPT_DOWN_KEY",
    "PRYX_SCROLL_PROMPT_UP_KEY",
    "PRYX_SCROLL_UP_FALLBACK_KEY",
    "PRYX_SCROLL_UP_KEY",
    "PRYX_SEARXNG_URL",
    "PRYX_SHOW_AGENTGREP_OUTPUT",
    "PRYX_SHOW_DIFFS",
    "PRYX_SHOW_THINKING",
    "PRYX_SIDE_PANEL_TOGGLE_KEY",
    "PRYX_SIDE_PANEL_NATIVE_SCROLLBAR",
    "PRYX_SMTP_PASSWORD",
    "PRYX_SPAWN_HOOK",
    "PRYX_STREAM_IDLE_TIMEOUT_SECS",
    "PRYX_SWARM_ENABLED",
    "PRYX_SWARM_MODEL",
    "PRYX_SWARM_MAX_CONCURRENT_AGENTS",
    "PRYX_SWARM_SPAWN_MODE",
    "PRYX_SWARM_STRIP_LAYOUT",
    "PRYX_TELEGRAM_BOT_TOKEN",
    "PRYX_TELEGRAM_CHAT_ID",
    "PRYX_TELEGRAM_REPLY_ENABLED",
    "PRYX_TOOL_CALL_DETAILS",
    "PRYX_TOOL_PROFILE",
    "PRYX_TOOLS",
    "PRYX_TRUSTED_EXTERNAL_AUTH_SOURCES",
    "PRYX_TYPING_SCROLL_LOCK_TOGGLE_KEY",
    "PRYX_UPDATE_CHANNEL",
    "PRYX_WEBSEARCH_ENGINE",
    "PRYX_WEBSEARCH_FALLBACK_ENGINES",
    "PRYX_WORKSPACE_DOWN_KEY",
    "PRYX_WORKSPACE_LEFT_KEY",
    "PRYX_WORKSPACE_RIGHT_KEY",
    "PRYX_WORKSPACE_UP_KEY",
    "XDG_CONFIG_HOME",
];
...
static CONFIG_CACHE: LazyLock<RwLock<ConfigCache>> = LazyLock::new(|| {
    ...
    // (e.g. copilot_premium -> PRYX_COPILOT_PREMIUM), and fingerprinting
...
pub fn config() -> &'static Config {
    ...
    let config = {
        ...
        if cache.force_reload || cache.fingerprint != fingerprint {
            ...
            // (e.g. copilot_premium propagates config -> PRYX_COPILOT_PREMIUM).
...
pub struct Config {
    ...
    /// Global "launch a new pryx" hotkeys (macOS). Baked once by auto-import.
...
pub struct AcpConfig {
    ...
    pub profile: String,
    /// Tool profile to request when `pryx acp` starts a daemon itself.
...
fn normalize_tool_name(name: &str) -> String {
    ...
    pryx_tool_types::resolve_tool_name(trimmed).to_string()
}
...
fn is_default_discovery_endpoint(endpoint: &str) -> bool {
    matches!(
        ...
        "https://api.pryx.sh/v1/discovery" | "https://api.solosystems.dev/v1/discovery"
    )
}
