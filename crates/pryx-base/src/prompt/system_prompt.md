...
Pryx is open source: <https://github.com/pryx-co/pryx>
...
There may be other pryx agents working in the codebase. The harness handles this natively without git worktrees.
