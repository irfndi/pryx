...
//! downstream `pryx-provider-antigravity-runtime` crate so provider edits do
...
//!   `pryx-provider-antigravity`) at their historical paths, and
...
pub use pryx_provider_antigravity::is_known_model;
pub use pryx_provider_antigravity::{
