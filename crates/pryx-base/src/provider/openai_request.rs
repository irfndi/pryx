...
use pryx_provider_openai::OpenAiRequestLogLevel;
use serde_json::Value;

pub fn build_responses_input(messages: &[ChatMessage]) -> Vec<Value> {
    pryx_provider_openai::build_responses_input_with_logger(messages, |level, message| match level
    {
