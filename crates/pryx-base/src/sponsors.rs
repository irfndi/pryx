...
//! system prompt.
//! Some providers may share revenue with Pryx when users choose their tools.
//! Partnership status never influences recommendations. The relationship is
//! disclosed in the UI with a link to <https://pryx.sh/discovery-tools>.
//!
...
/// Public URL explaining Pryx's tool-provider partnerships.
pub const DISCOVERY_PARTNERS_URL: &str = "https://pryx.sh/discovery-tools";
