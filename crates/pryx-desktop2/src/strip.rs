...
mod tests {
    ...
    fn strip() -> Strips {
        Strips::build(
            vec![
                Panel::new("a1", Some("/home/j/pryx")),
                Panel::new("a2", Some("/home/j/pryx")),
                Panel::new("a3", Some("/home/j/pryx")),
    ...
    fn grouping_is_by_working_dir_and_is_stable() {
        ...
        assert_eq!(strip.strips()[0].label, "pryx");
    ...
    fn label_uses_the_leaf_directory() {
        assert_eq!(label_for(Some("/home/j/pryx")), "pryx");
        assert_eq!(label_for(Some("/home/j/pryx/")), "pryx");
