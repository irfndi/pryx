...
impl Theme {
    ...
    /// The mode asked for by `PRYX_DESKTOP2_THEME=light|dark|system`.
    ...
    pub fn preference_from_env() -> ThemeMode {
        match std::env::var("PRYX_DESKTOP2_THEME").as_deref() {
    ...
    /// Resolve from the environment: `PRYX_DESKTOP2_THEME=light|dark|system`.
