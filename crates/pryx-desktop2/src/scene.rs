...
fn draw_hero_text(
    ...
    // The wordmark: the same "pryx" that sits above the donut on the website.
...
/// (`pryx-website pryx pryx-desktop2 ...`) and grew with every checkout.
...
fn draw_transcript(
    ...
    use pryx_render_core::BlockKind;
...
pub fn build_scene(
...

    {
        ...
        // "message pryx" is a caption you stop seeing, while a prompt you
