...
//! line up. [`pryx_math`] does the TeX box layout against the OpenType MATH
//! table of a vendored math font; this module owns the font handle and turns
//! the resulting positions into Vello draw calls.

use pryx_math::{Item, LayoutBox, MathLayoutEngine, MathLines};
use vello::Scene;
...
impl Default for MathSystem {
    fn default() -> Self {
        Self {
            font: FontData::new(Blob::new(std::sync::Arc::new(pryx_math::STIX_TWO_MATH)), 0),
        }
    }
}
