        ...
        match app.status() {
            ...
            ProcessingStatus::RunningTool(ref name) => {
                ...
                let bar_speed = if decorative {
                    ...
                    pryx_tui_style::theme::LIVENESS_INDICATOR_FPS / half_width as f32
                };
                ...
                spans.push(Span::styled(
                    format!(" · {} bg", pryx_tui_core::keybind::alt_chord("B")),
        ...
        append_batch_progress_spans(
            ...
            Some(crate::bus::BatchProgress {
                ...
                running: vec![crate::message::ToolCall {
                    ...
                    name: "bash".to_string(),
                    input: serde_json::json!({"command": "cargo test -p pryx"}),
                    intent: None,
