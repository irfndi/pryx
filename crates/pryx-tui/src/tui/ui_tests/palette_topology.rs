...
//!
//! The graph model in `pryx-tui-style::harmony::graph` needs to know which
...
use pryx_tui_style::palette::role_for_rendered;
...
fn measure() -> (
    ...
    pryx_tui_style::color::pin_truecolor_for_tests();
