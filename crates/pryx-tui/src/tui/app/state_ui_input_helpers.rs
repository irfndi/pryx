...
const REGISTERED_COMMANDS: &[RegisteredCommand] = &[
    ...
    RegisteredCommand::public(
        "/skills",
        "Show loaded skills and pryx-endorsed recommendations",
    ),
    ...
    RegisteredCommand::public("/feedback", "Send feedback about pryx"),
    RegisteredCommand::public("/telemetry", "Show or change what pryx sends"),
    RegisteredCommand::public("/support", "Email support with diagnostics prefilled"),
    RegisteredCommand::public("/subscription", "Show pryx subscription status"),
    RegisteredCommand::public("/subscribe", "Why and how to subscribe to pryx"),
    RegisteredCommand::public("/config", "Show or edit configuration"),
    RegisteredCommand::public("/log", "Mark the current location in the pryx logs"),
    RegisteredCommand::public(
        "/keys",
    ...
    RegisteredCommand::public("/selfdev", "Open a new self-dev pryx session"),
    ...
    RegisteredCommand::public("/quit", "Exit pryx"),
...
mod external_cli_suggestion_tests {
    ...
    /// Run with:
    ///   cargo test -p pryx-tui --lib onboarding_suggestion_scan_cost -- --ignored --nocapture
    #[test]
    #[ignore]
...
"#,
    ...
    fn parses_codex_input_text_blocks() {
        ...
        std::fs::write(
            &path,
            r#"{"type":"session_meta","payload":{"id":"sid","cwd":"/home/jeremy/pryx"}}
{"type":"response_item","payload":{"type":"message","role":"user","content":[{"type":"input_text","text":"check in on pryx"}]}}
"#,
        )
        .expect("write fixture");
        ...
        assert_eq!(candidate.working_dir.as_deref(), Some("/home/jeremy/pryx"));
        assert_eq!(candidate.context.as_deref(), Some("check in on pryx"));
    }
