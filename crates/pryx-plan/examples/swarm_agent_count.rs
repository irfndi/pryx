...
//!
//! This drives the *real* task-DAG engine (`pryx_plan::dag`) with scripted mock
...
//!
//! Run with: `cargo run -p pryx-plan --example swarm_agent_count`
//!
...
use pryx_plan::dag::sim::deep_artifact;
use pryx_plan::dag::{
