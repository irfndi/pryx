//! TeX-style math typesetting for pryx front-ends.
//!
//! `pryx-math` turns LaTeX math source into positioned glyphs and rules using
...
//!
//! ```
//! let engine = pryx_math::MathLayoutEngine::stix();
