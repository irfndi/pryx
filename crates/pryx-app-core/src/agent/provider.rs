...
impl Agent {
    ...
    pub fn model_catalog_snapshot(&self) -> pryx_provider_core::ModelCatalogSnapshot {
    ...
    pub fn active_resolved_credential(&self) -> Option<pryx_provider_core::ResolvedCredential> {
