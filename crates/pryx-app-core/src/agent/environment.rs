use super::{Agent, PRYX_REPO_SOURCE_STATE, WORKING_GIT_STATE_CACHE};
use crate::logging;
...
impl Agent {
    ...
    pub(super) fn build_env_snapshot(
        ...
        let (pryx_git_hash, pryx_git_dirty) = match detail {
            EnvSnapshotDetail::Full => PRYX_REPO_SOURCE_STATE.clone(),
        ...
        EnvSnapshot {
            ...
            pryx_version: pryx_build_meta::version().to_string(),
            pryx_git_hash,
            pryx_git_dirty,
