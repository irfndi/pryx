//! Client-server protocol for pryx
//!
...
use pryx_batch_types::BatchProgress;
use pryx_message_types::{InputShellResult, ToolCall};
use pryx_plan::{PlanItem, VersionedPlan, next_runnable_item_ids, summarize_plan_graph};
use pryx_side_panel_types::{SidePanelSnapshot, snapshot_is_empty};
...
pub type ReloadRecoverySnapshot = pryx_selfdev_types::ReloadRecoveryDirective;
...
impl PlanGraphStatus {
    ...
    pub fn from_versioned_plan(
        ...
        let growth = pryx_plan::bridge::growth_stats(plan);
        ...
        Self {
            ...
            newly_ready_ids,
            low_confidence_ids: pryx_plan::bridge::low_confidence_completed_ids(plan),
