...
/// Mirrors `pryx_plan::dag::NodeSpec` but kept as an explicit wire type so the
...
pub enum Request {
    ...
    Reload {
        ...
        /// `pryx server reload` can request a graceful upgrade without risking
    ...
    SetCompactionMode {
        id: u64,
        mode: pryx_config_types::CompactionMode,
    },
    ...
    /// Query pryx agent's capabilities
...
pub enum ServerEvent {
    ...
    SidePaneImages {
        session_id: String,
        images: Vec<pryx_session_types::RenderedImage>,
    },
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        available_model_routes: Vec<pryx_provider_core::ModelRoute>,
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        resolved_credential: Option<pryx_provider_core::ResolvedCredential>,
        ...
        #[serde(default)]
        compaction_mode: pryx_config_types::CompactionMode,
    ...
    CommListModelsResponse {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        model_routes: Vec<pryx_provider_core::ModelRoute>,
    },
