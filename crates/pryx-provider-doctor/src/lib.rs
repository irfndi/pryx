//! Provider-doctor diagnostics for pryx.
//!
//! Sits downstream of `pryx-base` so edits to the doctor cluster do not
//! rebuild the base -> app-core -> tui spine:
//! - [`provider_e2e`]: the strict end-to-end runner behind `pryx
