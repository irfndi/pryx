...
//!
//! Node weights and edges are *measured*, not declared: `pryx-tui` renders real
...
/// The topology measured from pryx's own rendered frames.
///
/// Regenerate with
/// `cargo test -p pryx-tui --lib print_measured_palette_topology -- --ignored --nocapture`
...
///
/// Area weighting is the entire point. pryx's default palette measures 0.10
