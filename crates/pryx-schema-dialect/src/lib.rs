...
//! # The recurring bug
//!
//! pryx sends its entire tool array on every request. Providers each accept a
...
//!    without waiting for a pryx release.
//!
//! # Adding a provider
//!
...
pub enum RecoveryAction {
    ...
    /// something pryx already strips or because it names nothing actionable.
